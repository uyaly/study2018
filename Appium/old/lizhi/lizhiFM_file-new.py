...
# driver.wait_activity("android.widget.EditText", 5)
# driver.find_element_by_class_name("android.widget.EditText").send_keys("18062427385")
# print("classname")
# driver.find_element_by_name("确认").click()
# driver.find_element_by_id("com.yibasan.lizhifm:id/header_left_button_img").click()

# driver.find_element_by_name("请输入你的手机号码").send_keys("18062427385")
# print("name")
# driver.find_element_by_name("确认").click()
# driver.find_element_by_id("com.yibasan.lizhifm:id/header_left_button_img").click()

# driver.find_element_by_id("com.yibasan.lizhifm:id/edit_text").send_keys("18062427385")
# print("id")
# driver.find_element_by_name("确认").click()
# driver.find_element_by_id("com.yibasan.lizhifm:id/header_left_button_img").click()
...
try:
    ...
    # 返回登录
    driver.find_element_by_id("com.yibasan.lizhifm:id/header_left_button_img").click()
    # driver.find_element_by_name("中国大陆(+86)").click()
    # driver.find_element_by_class_name("android.widget.EditText").send_keys("18062427385")
    driver.find_element_by_name("请输入你的手机号码").send_keys("18062427385")
    driver.find_element_by_id("com.yibasan.lizhifm:id/header_left_button_img").click()
...
driver.find_element_by_name("确认").click()
# 返回登录
driver.find_element_by_id("com.yibasan.lizhifm:id/header_left_button_img").send_keys("612101010")
