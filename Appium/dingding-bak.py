...
try:
    ...
    pass
try:
    driver.wait_activity("com.alibaba.android.user.login.SignUpWithPwdActivity", 10)
    print("登录页面：" + driver.current_activity)
    # 输入账号密码
...
time.sleep(3)
print("长江智联：" + driver.current_activity)
driver.wait_activity(".biz.home.activity.HomeActivity", 10)
...
driver.wait_activity("com.alibaba.lightapp.runtime.activity.CommonWebViewActivity", 10)
...
print("我的：" + driver.current_activity)
driver.wait_activity(".biz.home.activity.HomeActivity", 10)
