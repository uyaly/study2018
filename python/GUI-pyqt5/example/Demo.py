...
class Table(QWidget):
    ...
    def initUI(self):
        ...
        # newItem.setFont(QFont('Times', 12, QFont.Black))
        # tableWidget.setItem(1, 2.txt, newItem)
        #
        # newItem = QTableWidgetItem("王五")
        # #将字体加粗，黑色字体
        # newItem.setFont(QFont('Times',12,QFont.Black))
        # tableWidget.setItem(2.txt, 0, newItem)
        #
        # # 创建新条目，设置背景颜色，添加到表格指定行列中
        # newItem = QTableWidgetItem("女")
        # newItem.setFont(QFont('Times', 12, QFont.Black))
        # tableWidget.setItem(2.txt, 1, newItem)
        #
        # # 创建新条目，设置背景颜色，添加到表格指定行列中
        ...
        #tableWidget.setItem(2.txt, 2.txt, newItem)


        #按照体重排序
        #Qt.DescendingOrder降序
        #Qt.AscEndingOrder升序
        #tableWidget.sortItems(2.txt,Qt.DescendingOrder)

        #合并单元格
        #tableWidget.setSpan(2.txt,0,4,1)
