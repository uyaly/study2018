...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mix2.setGeometry(QtCore.QRect(240, 120, 41, 20))
        ...
        self.label_title.setGeometry(QtCore.QRect(20, 170, 211, 20))
        self.label_title.setText("")
        self.label_title.setObjectName("label_title")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(200, 170, 171, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "加法45"))
        self.plus.setText(_translate("MainWindow", "0"))
        self.minus.setText(_translate("MainWindow", "0"))
        self.label_3.setText(_translate("MainWindow", "减法55"))
        self.label_5.setText(_translate("MainWindow", "连加120"))
        self.plus2.setText(_translate("MainWindow", "0"))
        self.minus2.setText(_translate("MainWindow", "0"))
        self.label_6.setText(_translate("MainWindow", "连减165"))
        self.label_9.setText(_translate("MainWindow", "加减混合1430"))
        self.mix2.setText(_translate("MainWindow", "200"))
