...
#0bec6cb86212adea871ef265712b00c5     #key
...
def getStaticAmap(lonlat_str,str_city_center):      #<---获取静态高德地图--->
    ...
    #高德地图-->静态地图API地址
    url = r'http://restapi.amap.com/v3/staticmap?location=%s&zoom=10&size=1024*768&key=0bec6cb86212adea871ef265712b00c5'
...
if __name__=='__main__':         #<---主程序--->
    ...
    while i<15:                                    #循环,高德地图有<50个点限制
          ...
          df_2=df.ix[i,2]                           #地址
          df_3=df.ix[i,5]                           #处理量
          amap = r'http://restapi.amap.com/v3/geocode/geo?address=%s&city=上海&output=JSON&key=0bec6cb86212adea871ef265712b00c5'
          url_amap=amap % df_2
