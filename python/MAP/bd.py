...
if __name__ == '__main__':
    group = "test"
    keywords = ["长城坐标城", "蓝域拿铁公寓", "芭比伦堡", "万科城花璟苑", "铁箕山社区", "光谷理想城", "汤逊湖社区", "香山美树", "光谷麒麟社", "建发社区", "中建三局三公司", "中建康城", "曙光二村", "中铁七局公租房", "华夏学院教工公寓"]
    record_xls(group, keywords)

    # 1 d
    # "关山春晓", "金地太阳城", "逸景华庭", "江城雅居", "融科天域", "光谷新世界", "长航蓝晶国际", "阁调小区", "丽岛漫城", "保利时代", "保利时代天悦", "宏祥花园", "武职教工宿舍"
    # 1 x
    # "洪福家园", "洪福添美", "枫林上城", "金地阳光城", "阳光在线", "曙光嘉园", "鲁广花园", "中杰阳光", "阳光尚东", "光谷汇景", "万科锦程", "曙光星城 A 区", "曙光星城 B 区", "光谷青年城", "美庐郡园", "金地格林东郡", "中南民族大学", "纺织大学"
    # 2
    # "万科城市花园", "万科红郡", "当代国际花园", "现代森林小镇"
    # 3
    # "流芳老街", "佛祖岭 A 区", "佛祖岭 B 区", "佛祖岭 C 区", "佛祖岭 E区", "佛祖岭 F 区"
    # 4
    # "光谷 one39", "光谷 8 号", "联投喻园", "金鑫国际", "汇博苑", "金梭花园", "金地华公馆", "学府佳园", "巴黎豪庭", "保利花园", "茉莉公馆", "东湖广场", "剑桥春天", "华中科技大学", "长飞社区", "鼓风机厂宿舍", "华乐花园", "黄家店", "华城花园", "虹景花园", "电信小区"
    # 5
